...
/subsystem=datasources/data-source=mariadb:add(jndi-name="java:jboss/datasources/mariadb", use-java-context=true,connection-url="jdbc:mysql://localhost:3306/rhsso73x",driver-name="mariadb",user-name="rhsso73x",password="password")
